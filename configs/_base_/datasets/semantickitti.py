...
#data/mySemKitti_cir30
# class_names = [
#     'car', 'bicycle', 'motorcycle', 'truck', 'bus', 'person', 'bicyclist',
#     'motorcyclist', 'road', 'parking', 'sidewalk', 'other-ground', 'building',
#     'fence', 'vegetation', 'trunck', 'terrian', 'pole', 'traffic-sign'
# ]
class_names = ['duiliao', 'dabi', 'meipeng', 'yunmeiche', 
               'dangmeiqiang', 'guidao', 'dimian', 'fenchen', 
               'neimen', 'shiwai', 'madao', 'neiqiang', 
               'menji', 'bian']
...
#     50: 12,  # "building"
#     51: 13,  # "fence"
#     52: 19,  # "othshaser-structure" mapped to "unlabeled" ------mapped
...
# }
labels_map = {0: 0, 1: 1, 2: 2, 3: 3, 6: 4, 7: 5, 8: 6, 9: 7, 10: 8, 11: 9, 12: 10, 13: 11, 14: 12, 15: 13}


metainfo = dict(
    # classes=class_names, seg_label_mapping=labels_map, max_label=259)
    classes=class_names, seg_label_mapping=labels_map, max_label=15)
